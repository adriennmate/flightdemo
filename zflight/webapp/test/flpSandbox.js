		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight reservation demo",
									"targetURL": "#custmateasapflightzflight-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"custmateasapflightzflight-display": {
								"semanticObject": "custmateasapflightzflight",
								"action": "display",
								"description": "Flight reservation demo",
								"title": "Flight reservation demo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cust.matea.sap.flight.zflight",
									"url": sap.ui.require.toUrl("cust/matea/sap/flight/zflight")
								}
							}
						}
					}
